...
public class WhenCompletingATaskTest extends SingleEventTest<Task, CompleteTask, TaskCompleted>
    ...
    protected CompleteTask when() {
        return new CompleteTask(taskId, Instant.now().plus(1, DAYS));
    }
    ...
    public void then() {
        ...
        assertEquals(getCommand().getCompletedAt(), getPublishedEvent().getCompletedAt(), "Expected given completion date");
    }
}
