...
public class WhenCreatingANewTaskWithoutTitleTest extends SingleEventTest<Task, CreateTask, TaskCreated>
    ...
    protected CreateTask when() {
        return new CreateTask(ID.fromObject(UUID.randomUUID()), "", Instant.now().plus(2, DAYS));
    }
